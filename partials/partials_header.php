...
<nav class="navbar topbar sticky-top">
  <div class="container-fluid gap-2">
    ...
    <form class="topbar-search d-none d-md-flex align-items-center position-relative"
...
$openBilling  = in_array($__active, ['billing','due_report','due_report_pro','invoices','invoices_paid','invoice_new','collections','collections_today'], true);
...
$openSettings = in_array($__active, ['settings','settings_tg','settings_bkash','settings_location_area','settings_location_sub_zone','settings_location_box'], true);
