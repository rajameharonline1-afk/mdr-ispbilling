...
$pid = (int)($_GET['payment_id'] ?? $_GET['pid'] ?? $_GET['id'] ?? 0);
if ($pid <= 0){
...
$sql = "SELECT pay.*,
               ...
               MONTH(inv.billing_month) AS inv_month,
               YEAR(inv.billing_month)  AS inv_year,
...
$company_name = (string)(settings_get('company_name', '') ?: 'Your ISP');
$company_phone= (string)(settings_get('company_phone', '') ?: '');
$company_addr = (string)(settings_get('company_address', '') ?: '');
