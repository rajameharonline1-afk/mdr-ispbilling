...
$new_id = null;
$new_invoice = null;
$auto_invoice = 1; // default: generate first invoice on client add
...
if (($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'POST') {
    ...
    // Auto-invoice toggle (checkbox unchecked => 0)
        ...
        <div class="card-block h-100">
          ...
          <div class="p-3">
            ...
            <div class="form-check mt-2">
              <input class="form-check-input" type="checkbox" id="auto_invoice" name="auto_invoice" value="1" <?= $auto_invoice ? 'checked' : '' ?>>
